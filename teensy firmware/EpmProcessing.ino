...
void initFilters() {
    for (int i = 0; i < 8; i++) {
        // highPass
        highPass[i] = { 0.076127718011f, 0.152255436022f, 0.076127718011f, -1.090984621642f, 0.404284924991f};
        // lowPass
        lowPass[i] = { 1.000000000000f, -2.000000000000f, 1.000000000000f, -1.955836804150f, 0.956883474249f};
        // 60 Hz notch
        notch60[i] = { 0.998431665917f, -1.988001181684f, 0.998431665917f, -1.988001181684f, 0.996863331833f};
    }
}
