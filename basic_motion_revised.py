...
with ankle:
    ...
    for t in clock:
        ...
        print(f"Ankle Desired {ankle_setpoint:+.2f} rad, Ankle Actual {ankle.output_position:+.2f} rad")

        # , \
        #         Knee Desired {knee_setpoint:+.2f} rad, Knee Actual {knee.output_position:+.2f} rad",
        #     end="\r",
